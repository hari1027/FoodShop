...
const FilterDrawerScreen = () => {
    ...
    const FilterShops = async (values) => {
        try {
            const response = await axios.post('http://10.0.2.2:5000/FilterFoodshop', values);
    ...
    const validationSchema = yup.object().shape({
        shopName: yup.string()
            ...
            .matches(/^[a-zA-Z\s]+$/, 'Shop Name will not have special characters and Numbers'),
        shopAddress: yup.string()
            .min(2, 'Shop Address must be at least 2 characters')
            .max(500, 'Shop Address cannot exceed 500 characters')
            .matches(/^[a-zA-Z0-9\s,\/]+$/, 'Shop Location will have only contain letters, numbers and forward slash and comma'),
  ...
  return (
    <Formik
    initialValues={{ shopName: '', shopAddress: '', shopCategory: '', foodCuisines: [] }}
        ...
        <View style={styles.fieldsDiv}>
         <View>
                            ...
                            <View>
                                ...
                                <View>
                                <Text style={styles.fieldNamesText}>Filter By FoodCuisines :</Text>
                                <View style={styles.textBox}>
