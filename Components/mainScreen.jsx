          ...
          {!addShopForm && !deleteShopForm && !updateShopForm &&
                <View style={{ display: 'flex', flex: 1, flexDirection: 'column' }}>
                  <View style={{ display: 'flex', backgroundColor: '#fff' }}>
                    <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginRight: 16, marginLeft: 16, marginTop: 8, marginBottom:8 }}>
                      ...
                      <View style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                        <Icon name="filter" size={24} color="#007bff" onPress={() => navigation.openDrawer()} />
