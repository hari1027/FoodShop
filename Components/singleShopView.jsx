...
const SingleShopView = props => {
  ...
  const submitFeedBack = async (rating, values) => {
    ...
    try {
      const response = await axios.post(
        'https://food-shop-server-eegl.vercel.app/submitFeedback',
        obj,
      );
  ...
  const bookMarkThisShop = async () => {
    ...
    try {
      const response = await axios.post(
        'https://food-shop-server-eegl.vercel.app/bookmarkShop',
        values,
      );
      if (response.status === 200) {
  ...
  const removebookMarkOfThisShop = async () => {
    ...
    try {
      const response = await axios.post(
        'https://food-shop-server-eegl.vercel.app/removeShopFromBookmark',
        values,
      );
      if (response.status === 200) {
  ...
  const getSavedList = async () => {
    try {
      const response = await axios.get(
        `https://food-shop-server-eegl.vercel.app/getBookmarkedShops/${uniqueEmailId}`,
      );
      if (response.status === 200) {
  ...
  const getCommentsList = async () => {
    try {
      const response = await axios.get(
        `https://food-shop-server-eegl.vercel.app/getCommentsList/${props.shopDetails._id}`,
      );
      if (response.status === 200) {
