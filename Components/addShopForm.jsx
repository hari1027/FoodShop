...
const AddShopForm = (props) => {
    ...
    const addShop = async (values) => {
        try {
            const response = await axios.post('http://10.0.2.2:5000/FoodShop', values);
    ...
    return (
        <Formik
            initialValues={{ shopName: '', shopAddress: '', shopCategory: '', foodCuisines: [], shopOwnerName: '', shopOwnerNumber: '' }}
